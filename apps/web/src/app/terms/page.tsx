export default function TermsPage() {
  return (
    <main className="text-page">
      <span className="section-kicker">PHÁP LÝ</span>
      <h1>Điều khoản sử dụng</h1>
      <p>Cập nhật: 07/08/2026</p>

      <h2>Vai trò của nền tảng</h2>
      <p>
        TWS Community Market giúp thành viên đăng và tìm sản phẩm. Nền tảng
        không xử lý thanh toán, không giữ tiền và không cung cấp dịch vụ ký quỹ.
        Các bên chịu trách nhiệm kiểm tra sản phẩm, thống nhất giao dịch và tuân
        thủ pháp luật áp dụng.
      </p>

      <h2>Sử dụng thông tin liên hệ của thành viên khác</h2>
      <p>
      ...
      <p>
        Hành vi lạm dụng thông tin liên hệ có thể bị gỡ nội dung, hạn chế quyền
        đăng bài hoặc khóa tài khoản tùy mức độ. Nền tảng có thể lưu bằng chứng
        cần thiết để xử lý báo cáo, bảo vệ thành viên và đáp ứng yêu cầu pháp
        luật hợp lệ.
      </p>
