export default function PrivacyPage() {
  return (
    <main className="text-page">
      ...
      <h2>Dữ liệu chúng tôi sử dụng</h2>
      <p>
        Khi bạn đăng nhập bằng Google, hệ thống nhận mã tài khoản theo ứng dụng,
        tên hiển thị, email và ảnh đại diện do Google cung cấp. Khi đăng nhập
        bằng OTP, hệ thống lưu email đã xác nhận; mã OTP chỉ dùng một lần, hết
        hạn sau 10 phút và chỉ được lưu dưới dạng bản băm. Số điện thoại và liên
        kết Facebook trong hồ sơ là thông tin do người dùng tự khai báo.
      </p>
